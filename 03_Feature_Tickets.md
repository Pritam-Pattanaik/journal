...
| INF-003 | Set up Supabase project (dev + prod) | P0 | S | 1 | — |
| INF-004 | Configure Supabase local dev environment | P0 | S | 1 | INF-003 |
...
| ID | Ticket | Priority | Effort | Phase | Depends On |
|---|---|---|---|---|---|
| AUTH-001 | Create Supabase Auth configuration (email + Google OAuth) | P0 | S | 2 | INF-003 |
...
| DB-008 | Set up Supabase Vault for encrypted secret storage | P0 | M | 2 | INF-003 |
...
| DASH-007 | Wire all dashboard charts to real Supabase data | P0 | M | 2 | DASH-002 through DASH-006, DB-001 |
...
| STRAT-004 | Wire strategy CRUD to Supabase | P1 | M | 2 | DB-002, STRAT-003 |
...
| JRNL-004 | Implement journal CRUD to Supabase | P0 | M | 2 | DB-003, JRNL-001 |
...
| AI-005 | Create Supabase Edge Function: `run-ai-analysis` | P0 | L | 2 | DB-001, DB-005 |
...
| Phase 2 | Supabase backend + auth + broker APIs + real data | Weeks 4–7 |
